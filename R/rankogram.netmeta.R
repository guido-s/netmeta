...
#' 
#' The following components are available if argument \code{common = TRUE}:
...
#' \item{samples.common}{Generated samples for the common effects model
#'   (if \code{keep.samples = TRUE}).}
#' 
#' The following components are available if argument \code{random = TRUE}:
...
#' \item{samples.random}{Generated samples for the random effects model
#'   (if \code{keep.samples = TRUE}).}
#'
...
#' rnk
#' print(rnk, cumulative.rankprob = TRUE)
#'
